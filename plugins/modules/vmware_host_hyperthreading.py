            ...
            if desired_state == "enabled":
                ...
                if hyperthreading_info.config:
                    if hyperthreading_info.active:
                        ...
                        results["result"][host.name][
                            "msg"
                        ] = "Hyperthreading is enabled and active"
                    if not hyperthreading_info.active:
                        ...
                        try:
                            mitigation = option_manager.QueryOptions(
                        ...
                        if mitigation and mitigation[0].value:
                            ...
                            results["result"][host.name]["msg"] = (
                                "Hyperthreading is enabled, but not active because the"
                            ...
                            results["result"][host.name]["msg"] = (
                                "Hyperthreading is enabled, but not active."
                ...
                # Enable Hyperthreading
                    ...
                    if hyperthreading_info.available:
                        if not self.module.check_mode:
                            ...
                            results["result"][host.name][
                                "msg"
                            ] = "Hyperthreading will be enabled"
                    else:
                        self.module.fail_json(
                            msg="Hyperthreading optimization is not available for host '%s'"
                            % host.name
                        )
                ...
                if not hyperthreading_info.config:
                    if not hyperthreading_info.active:
                        ...
                        results["result"][host.name][
                            "msg"
                        ] = "Hyperthreading is disabled and inactive"
                    if hyperthreading_info.active:
                        changed = results["result"][host.name][
                            "changed"
                        ] = True
                        ...
                        results["result"][host.name]["msg"] = (
                            "Hyperthreading is already disabled"
