...
class VmwareRestClient(object):
    ...
    def get_tag_by_name(self, tag_name=None):
        ...
        return self.search_svc_object_by_name(
            service=self.api_client.tagging.Tag, svc_obj_name=tag_name
        )
    ...
    def get_category_by_name(self, category_name=None):
        ...
        return self.search_svc_object_by_name(
            service=self.api_client.tagging.Category,
            svc_obj_name=category_name,
        )
    ...
    def get_tag_by_category(self, tag_name=None, category_name=None):
        ...
        if category_name:
            category_obj = self.get_category_by_name(
            ...
            for tag_object in self.api_client.tagging.Tag.list():
                ...
                if (
                    ...
                    and tag_obj.category_id == category_obj.id
                ):
                    return tag_obj
        else:
            return self.search_svc_object_by_name(
